...
model = apps.get_model('diary', 'Member')

class Room(models.Model):
    counselor = models.ForeignKey(model, related_name='counselor_room', on_delete=models.CASCADE)
    client = models.ForeignKey(model, related_name='client_room', on_delete=models.CASCADE)
...
class CounselorInfo(models.Model):
    member = models.ForeignKey(model, on_delete = models.CASCADE)
...
class Match(models.Model):
    counselor = models.ForeignKey(model, related_name='counselor', on_delete=models.CASCADE)
    client = models.ForeignKey(model, related_name='client', on_delete=models.CASCADE)
